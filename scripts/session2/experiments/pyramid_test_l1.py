...
if __name__ == '__main__':
    ...
    pyramid_svm, std_scaler, pca = classification.train_pyramid_svm(vis_words, labels, C=840.42, dim_reduction=None, model_name='svm_pyramid_l1' )
    ...
    io.save_object(test_results, 'results_pyramid_l1')
