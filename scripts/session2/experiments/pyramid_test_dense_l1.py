...
if __name__ == '__main__':
    ...
    pyramid_svm, std_scaler, pca = classification.train_pyramid_svm(vis_words, labels, C=1.396, dim_reduction=None, model_name='svm_pyramid_dense_l1' )
    ...
    io.save_object(test_results, 'results_pyramid_dense_l1')
    io.save_object(test_results, 'classes_pyramid_dense_l1')
