...
# Transform everything to numpy arrays
            ...
            clf.fit(D_scaled, L)
            with open('SVMdef_SIFT_sigma'+str(sigma)+'_cT'+str(ct)+'_eT'+str(et)+'.pickle', 'w') as f:
                cPickle.dump(clf, f)
            ...
            for i in range(len(test_images_filenames)):
                ...
                with open('predictedclass_SVMdef_SIFT_sigma' + str(sigma) + '_cT' + str(ct) + '_eT' + str(et) + '.pickle', 'w') as f:
                    cPickle.dump(predictedclass, f)
            ...
            with open('accuracy_SVMdef_SIFT_sigma' + str(sigma) + '_cT' + str(ct) + '_eT' + str(et) + '.pickle',
                      'w') as f:
...
with open('global_accuracy.pickle', 'w') as f:
