...
# Results names
results_name = '{}_dropoutfc_{}_dropoutconv_{}'.format(
...
model = cnn.baseline_cnn_dropout(img_width, img_height, regularization=regularization,
                                 dropout_fc=dropout_fc, dropout_conv=dropout_conv)
