...
def baseline_cnn_alt_mod(img_width, img_height, regularization=0.01):
    x = Input(shape=(img_width, img_height, 3), name='input')
...
def baseline_cnn_dropout_fc(img_width, img_height, regularization=0.01, dropout=0.5, gaussian_noise=False, sigma=0.05):
    x = Input(shape=(img_width, img_height, 3), name='input')
